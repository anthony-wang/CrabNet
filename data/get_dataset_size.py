...
# %%
print(df_benchmark[['mat_prop', 'train_diversity']].to_latex(index=False, escape=True, float_format="{:0.3f}".format))
print(df_matbench_cv.groupby('mat_prop').agg({'mat_prop':'first', 'train_diversity': 'mean'}).to_latex(index=False, escape=True, float_format="{:0.3f}".format))
# print(df_matbench_cv.groupby('mat_prop').agg({'mat_prop':'first', 'train_diversity': ['mean', 'std']}).to_latex(index=False, escape=True, float_format="{:0.3f}".format))
